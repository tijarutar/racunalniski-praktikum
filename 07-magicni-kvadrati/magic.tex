...
\[
\m(n) = \frac12 n(n^2+1) \tag{\ref{eq:mc}}
\]% sklic: eq:mc
...
180 stopinj okrog središča, kvadrat iz tabele \ref{closhu} pa je mogoče dobiti
...
red & 1 & 2 & 3 & 4 & 5 & 6 \\ 
število kvadratov 
    & 1 & 0 & 1 & 880 & 275305224 & $(1{,}7745 \pm 0{,}0016)\cdot 10^{19}$ \\ 
\hline
\end{tabular}
...
R. Schroeppel leta 1973 (glej Gardner \cite{bessy} \cite{berlekamp}).
Natančno število vseh različnih normalnih magičnih kvadratov reda 6 ni znano.
Avtorja navedenega približka sta Pinn in Wieczerkowski (glej \cite{gardner} \cite{pinn}), ki
...
V tabelah \ref{tabel:mag5}, \ref{tabel:mag6} in \ref{tabel:mag9} so prikazani
